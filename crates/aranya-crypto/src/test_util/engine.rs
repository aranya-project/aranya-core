...
use crate::{
    ...
    id::{BaseId, IdExt as _, Identified as _},
...
pub fn test_afc_derive_bidi_keys<E: Engine>(eng: &mut E) {
    ...
    let ch1 = afc::BidiChannel {
        parent_cmd_id: BaseId::random(eng),
        our_sk: &sk1,
