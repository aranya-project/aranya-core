//! Bridge code for `const_generic_exprs` and typenum-based
//! generic arrays.

// Code taken from
// https://github.com/RustCrypto/utils/blob/6ad2abf2b41feef6f8adf9fdaee5fb9c9b1e3849/hybrid-array/src/lib.rs
//
// Modified to add additional constants.
...
mod tests {
    ...
    fn tryfrom_slice_for_array_ref() {
        ...
        let array_ref =
            ByteArray::<U6>::try_from(slice).expect("should be able to convert from slice");
